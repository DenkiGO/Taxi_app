...
"}")
        ...
        self.label_17.setGeometry(QtCore.QRect(40, 205, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Istok Web")
        font.setPointSize(13)
        font.setBold(True)
...
"color: rgb(29, 29, 29);")
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(0, 160, 191, 31))
        font = QtGui.QFont()
        font.setFamily("Istok Web")
        font.setPointSize(13)
        font.setBold(True)
...
"color: rgb(140, 153, 169);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_17.setText(_translate("MainWindow", "История заказов"))
